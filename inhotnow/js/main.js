$(document).ready(function(){
	...
	var scrollTop;
   	...
   	$(window).scroll(function() {
	  	...
	  	var ar = $('#ar').offset().top;
	  	var ar_height = $('#ar').height();
		...
		if (scrollTop >= ar && scrollTop < ar + ar_height) {
			$('#site-navigation a[href*="ar"]').parent().addClass('current-menu-item');
		}
    ...
    img.setAttribute("src","css/images/morph.png");
    img.setAttribute("onclick","removeOneWorkitemLine(this);");
    img.setAttribute("onmouseover","this.src=\"css/images/dianjiph.png\";");
    img.setAttribute("onmouseout","this.src=\"css/images/morph.png\";");
