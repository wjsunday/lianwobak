...
class AdSpaceAddons extends NormalAddons
{
    ...
    public function adminMenu()
    {
        ...
        $menu['userAdSpace'] = '用户广告位';
        $menu['addUserAdSpace'] = '添加用户广告位';
        ...
        $page = isset($_GET['page']) ? t($_GET['page']) : 'addUserAdSpace';
        if ($page === 'editUserAdSpace') {
            unset($menu['addUserAdSpace']);
            $menu['editUserAdSpace'] = array('content' => '编辑用户广告位', 'param' => array('id' => intval($_GET['id'])));
        }
