...
class UserGroupModel extends Model
{
    ...
    protected $fields = array(0 => 'user_group_id', 1 => 'user_group_name', 2 => 'ctime', 3 => 'user_group_icon', 4 => 'user_group_type', 5 => 'app_name', 6 => 'is_authenticate', 6 => 'is_vip', 7 => 'is_business_vip');
    ...
    public function addUsergroup($d)
    {
        ...
        isset($d['is_vip']) && $data['is_vip'] = intval($d['is_vip']);
        isset($d['is_business_vip']) && $data['is_business_vip'] = intval($d['is_business_vip']);
        //dump($data);exit;
