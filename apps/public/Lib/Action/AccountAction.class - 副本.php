...
class AccountAction extends Action
{
    ...
    public function vip(){
        ...
        $pri = M('user_group')->join('ts_vip_price ON ts_user_group.user_group_id = ts_vip_price.u_g_id')->where('user_group_id > 6')->field('user_group_name,user_group_id,vip_price')->select();
        $uid = $this->mid;
        $vip = M('vip')->field('vip_name,Registration_time,due_time')->where("u_id = $uid and status = 1")->find();
        $day = time();
        $d_t = $vip['due_time'];
    ...
    public function vip_pay(){
        ...
        $dd['vip_order'] = time().rand(1,9).rand(1,9).rand(1,9).rand(1,9);
        $dd['u_id'] = $this->mid;
