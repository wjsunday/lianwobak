...
class Event extends Model
{
     ...
     * @var array
     **/
    protected $fields = array('eid', 'name', 'stime', 'etime', 'area', 'city', 'location', 'longitude', 'latitude', 'place', 'image', 'manNumber', 'remainder', 'price', 'cid', 'audit', 'content', 'uid', 'del', 'tips','num');
