 ...
 * 活动分类模型
 *
 * @package Apps\Bonusevent\Model\Cate
...
class Cate extends Model
{
     ...
     * @var string
     **/
    protected $tableName = 'bonusevent_cate';
    ...
    {
        $cid = intval($cid);
        $data = S('Apps_Bonusevent_Cate_'.$cid);
        if ($data) {
            return $data;
        }
        ...
        S('Apps_Bonusevent_Cate_'.$cid, $data);
    ...
    public function getAdminList()
    {
        ...
        foreach ($list['data'] as $key => $value) {
            $value['action'] = '<a href="'.U('Bonusevent/Admin/AddCate', array('tabHash' => 'index', 'id' => $value['cid'])).'">[编辑]</a>';
            $value['action'] .= '&nbsp;-&nbsp;';
            $value['action'] .= '<a href="'.U('Bonusevent/Admin/delCate', array('ids' => $value['cid'])).'">[删除]</a>';
            $list['data'][$key] = $value;
        }
    ...
    {
        $cid and S('Apps_Bonusevent_Cate_'.$cid, null);

        return S('Apps_Bonusevent_Cate_All', null);
    }
