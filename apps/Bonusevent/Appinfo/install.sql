--
-- 活动分类
-- ts_bonusevent_cate 结构
--
DROP TABLE IF EXISTS `ts_bonusevent_cate`;
CREATE TABLE IF NOT EXISTS `ts_bonusevent_cate` (
...
CREATE TABLE IF NOT EXISTS `ts_bonusevent_list` (
...
CREATE TABLE IF NOT EXISTS `ts_bonusevent_enrollment` (
...
CREATE TABLE IF NOT EXISTS `ts_bonusevent_star` (
